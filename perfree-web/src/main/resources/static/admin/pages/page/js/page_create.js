let form, xmSelect,categorySelect,tagSelect,toast, utils,layer;
layui.use(['layer', 'form', 'xmSelect', 'toast','utils'], function () {
    form = layui.form;
...
function submitArticle(data) {
    ...
    utils.ajax({
        ...
        success: function (d) {
            if (d.code === 200) {
                location.reload();
                toast.success({message: '页面添加成功',position: 'topCenter'});
